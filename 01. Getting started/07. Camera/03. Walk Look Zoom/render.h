...
private:
    ...
    void on_enter(Gtk::EventControllerMotion, gdouble x, gdouble y);
    void on_motion(Gtk::EventControllerMotion, gdouble x, gdouble y);
    void on_leave(Gtk::EventControllerMotion);
    Gtk::EventControllerMotion mouseMoveEvents;

    bool on_scroll(Gtk::EventControllerScroll, gdouble x, gdouble y);
